d3 = function () {
    ...
    function Q(n, t, e) {
        ...
        return u = tt(u) * ja, r = tt(r) * Ha, i = tt(i) * Fa, ot(rt(3.2404542 * u - 1.5371385 * r - .4985314 * i), rt(-.969266 * u + 1.8760108 * r + .041556 * i), rt(.0556434 * u - .2040259 * r + 1.0572252 * i))
    }
    ...
    function ft(n, t, e) {
        ...
        var r = et((.4124564 * n + .3575761 * t + .1804375 * e) / ja), u = et((.2126729 * n + .7151522 * t + .072175 * e) / Ha), i = et((.0193339 * n + .119192 * t + .9503041 * e) / Fa);
    ...
    function ee(n) {
        ...
        function e(n) {
            ...
            return{lineStart: function () {
                ...
                if (!e && (s = c = v) && n.lineStart(), v !== c && (g = r(e, p), (jt(e, g) || jt(p, g)) && (p[0] += ka, p[1] += ka, v = t(p[0], p[1]))), v !== c)l = 0, v ? (n.lineStart(), g = r(p, e), n.point(g[0], g[1])) : (g = r(e, p), n.point(g[0], g[1]), n.lineEnd()), e = g; else if (a && e && o ^ v) {
                    var m;
    ...
    function ue(n, t, e, r) {
        ...
        return function (a) {
            ...
            var d, m, y, x, M, _, b, w, S, k, E, A = a, C = Jt(), N = re(n, t, e, r), L = {point: h, lineStart: g, lineEnd: p, polygonStart: function () {
                a = C, d = [], m = [], E = !0
            }, polygonEnd: function () {
                a = A, d = Zo.merge(d);
    ...
    function me(n) {
        function t(t) {
            ...
            var f, h, g, p, v, d, m, y, x, M, _, b, w, S = {point: r, lineStart: u, lineEnd: a, polygonStart: function () {
        ...
        function e(t, i, o, a, c, s, l, f, h, g, p, v, d, m) {
            ...
            if (M > 4 * r && d--) {
                ...
                (q * q / M > r || ua((y * L + x * T) / M - .5) > .3 || u > a * g + c * p + s * v) && (e(t, i, o, a, c, s, C, N, E, _ /= S, b /= S, w, d, m), m.point(C, N), e(C, N, E, _, b, w, l, f, h, g, p, v, d, m))
            }
        }

        var r = .5, u = Math.cos(30 * Aa), i = 16;
    ...
    function Ne(n, t) {
        ...
        return function (u, i, o, a) {
            var c = o * t;
            null != u ? (u = Le(e, u), i = Le(e, i), (o > 0 ? i > u : u > i) && (u += o * wa)) : (u = n + o * wa, i = n - .5 * c);
    ...
    function We() {
        dr(this), this.edge = this.site = this.circle = null
    }
    ...
    function Ge(n) {
        ar(n), Zc.remove(n), $c.push(n), dr(n)
    }

    function Ke(n) {
        var t = n.circle, e = t.x, r = t.cy, u = {x: e, y: r}, i = n.P, o = n.N, a = [n];
        Ge(n);
        for (var c = i; c.circle && ua(e - c.circle.x) < ka && ua(r - c.circle.cy) < ka;)i = c.P, a.unshift(c), Ge(c), c = i;
        a.unshift(c), ar(c);
        for (var s = o; s.circle && ua(e - s.circle.x) < ka && ua(r - s.circle.cy) < ka;)o = s.N, a.push(s), Ge(s), s = o;
        a.push(s), ar(s);
        var l, f = a.length;
        for (l = 1; f > l; ++l)s = a[l], c = a[l - 1], gr(s.edge, c.site, s.site, u);
        c = a[0], s = a[f - 1], s.edge = fr(c.site, s.site, null, u), or(c), or(s)
    }

    function Qe(n) {
        for (var t, e, r, u, i = n.x, o = n.y, a = Zc._; a;)if (r = nr(a, o) - i, r > ka)a = a.L; else {
            if (u = i - tr(a, o), !(u > ka)) {
        ...
        var c = Je(n);
        if (Zc.insert(t, c), t || e) {
            if (t === e)return ar(t), e = Je(t.site), Zc.insert(c, e), c.edge = e.edge = fr(t.site, c.site), or(t), or(e), void 0;
            if (!e)return c.edge = fr(t.site, c.site), void 0;
            ar(t), ar(e);
            ...
            gr(e.edge, s, p, M), c.edge = fr(s, n, null, M), e.edge = fr(n, p, null, M), or(t), or(e)
        }
    }
    ...
    function rr(n) {
        for (var t, e, r, u, i, o, a, c, s, l, f = n[0][0], h = n[1][0], g = n[0][1], p = n[1][1], v = Ic, d = v.length; d--;)if (i = v[d], i && i.prepare())for (a = i.edges, c = a.length, o = 0; c > o;)l = a[o].end(), r = l.x, u = l.y, s = a[++o % c].start(), t = s.x, e = s.y, (ua(r - t) > ka || ua(u - e) > ka) && (a.splice(o, 0, new pr(hr(i.site, l, ua(r - f) < ka && p - u > ka ? {x: f, y: ua(t - f) < ka ? e : p} : ua(u - p) < ka && h - r > ka ? {x: ua(e - p) < ka ? t : h, y: p} : ua(r - h) < ka && u - g > ka ? {x: h, y: ua(t - h) < ka ? e : g} : ua(u - g) < ka && r - f > ka ? {x: ua(e - g) < ka ? t : f, y: g} : null), i.site, null)), ++c)
    }
    ...
    function ir() {
        dr(this), this.x = this.y = this.arc = this.site = this.cy = null
    }
    ...
    function or(n) {
        ...
        if (t && e) {
            ...
            if (r !== i) {
                ...
                if (!(h >= -Ea)) {
                    var g = c * c + s * s, p = l * l + f * f, v = (f * g - s * p) / h, d = (c * p - l * g) / h, f = d + a, m = Bc.pop() || new ir;
                    m.arc = n, m.site = u, m.x = v + o, m.y = f + Math.sqrt(v * v + d * d), m.cy = f, n.circle = m;
                    for (var y = null, x = Xc._; x;)if (m.y < x.y || m.y === x.y && m.x <= x.x) {
                        if (!x.L) {
                            y = x.P;
                            break
                        }
    ...
    function ar(n) {
        var t = n.circle;
        t && (t.P || (Vc = t.N), Xc.remove(t), Bc.push(t), dr(t), n.circle = null)
    }

    function cr(n) {
        for (var t, e = Yc, r = re(n[0][0], n[0][1], n[1][0], n[1][1]), u = e.length; u--;)t = e[u], (!sr(t, n) || !r(t) || ua(t.a.x - t.b.x) < ka && ua(t.a.y - t.b.y) < ka) && (t.a = t.b = null, e.splice(u, 1))
    }
    ...
    function fr(n, t, e, r) {
        var u = new lr(n, t);
        return Yc.push(u), e && gr(u, n, t, e), r && gr(u, t, n, r), Ic[n.i].edges.push(new pr(u, n, t)), Ic[t.i].edges.push(new pr(u, t, n)), u
    }

    function hr(n, t, e) {
        var r = new lr(n, null);
        return r.a = t, r.b = e, Yc.push(r), r
    }
    ...
    function Mr(n, t) {
        var e, r, u, i = n.sort(_r).pop();
        for (Yc = [], Ic = new Array(n.length), Zc = new vr, Xc = new vr; ;)if (u = Vc, i && (!u || i.y < u.y || i.y === u.y && i.x < u.x))(i.x !== e || i.y !== r) && (Ic[i.i] = new er(i), Qe(i), e = i.x, r = i.y), i = n.pop(); else {
            if (!u)break;
            Ke(u.arc)
        }
        t && (cr(t), rr(t));
        var o = {cells: Ic, edges: Yc};
        return Zc = Xc = Yc = Ic = null, o
    }
    ...
    function Er(n, t, e, r, u, i) {
        if (!n(t, e, r, u, i)) {
            var o = .5 * (e + u), a = .5 * (r + i), c = t.nodes;
            c[0] && Er(n, c[0], e, r, o, a), c[1] && Er(n, c[1], o, r, u, a), c[2] && Er(n, c[2], e, a, o, i), c[3] && Er(n, c[3], o, a, u, i)
        }
    }
    ...
    function Cr(n, t) {
        var e, r = {}, u = {};
        for (e in n)e in t ? r[e] = Tr(n[e], t[e]) : u[e] = n[e];
    ...
    function Lr(n, t) {
        ...
        for (n += "", t += "", Jc.lastIndex = 0, r = 0; e = Jc.exec(t); ++r)e.index && s.push(t.substring(a, c = e.index)), l.push({i: s.length, x: e[0]}), s.push(null), a = Jc.lastIndex;
        for (a < t.length && s.push(t.substring(a)), r = 0, i = l.length; (e = Jc.exec(n)) && i > r; ++r)if (o = l[r], o.x == e[0]) {
            ...
            l.splice(r, 1), i--, r--
        } else o.x = Nr(parseFloat(e[0]), parseFloat(o.x));
    ...
    function qr(n, t) {
        ...
        for (e = 0; a > e; ++e)r.push(Tr(n[e], t[e]));
        for (; i > e; ++e)u[e] = n[e];
        for (; o > e; ++e)u[e] = t[e];
        return function (n) {
    ...
    function Jr(n) {
        var t = [n.a, n.b], e = [n.c, n.d], r = Kr(t), u = Gr(t, e), i = Kr(Qr(e, t, -u)) || 0;
    ...
    function ru(n) {
        for (var t = n.source, e = n.target, r = iu(t, e), u = [t]; t !== r;)t = t.parent, u.push(t);
    ...
    function iu(n, t) {
        if (n === t)return n;
        for (var e = uu(n), r = uu(t), u = e.pop(), i = r.pop(), o = null; u === i;)o = u, u = e.pop(), i = r.pop();
        return o
    }
    ...
    function lu(n, t, e) {
        var r = 0, u = 0;
        if (n.charge = 0, !n.leaf)for (var i, o = n.nodes, a = o.length, c = -1; ++c < a;)i = o[c], null != i && (lu(i, t, e), n.charge += i.charge, r += i.charge * i.cx, u += i.charge * i.cy);
        if (n.point) {
    ...
    function fu(n, t) {
        return Zo.rebind(n, t, "sort", "children", "value"), n.nodes = n, n.links = vu, n
    }
    ...
    function Su(n, t) {
        return ku(n, Math.ceil(Math.log(t.length) / Math.LN2 + 1))
    }
    ...
    function Lu(n, t) {
        var e = n.children;
        if (e && (u = e.length))for (var r, u, i = -1; ++i < u;)t(r = Lu(e[i], t), n) > 0 && (n = r);
        return n
    }
    ...
    function Yu(n) {
        ...
        if ((e = n.children) && (s = e.length)) {
            ...
            if (e.forEach(Iu), r = e[0], r.x = -r.r, r.y = 0, t(r), s > 1 && (u = e[1], u.x = u.r, u.y = 0, t(u), s > 2))for (i = e[2], Xu(r, u, i), t(i), Hu(r, i), r._pack_prev = i, Hu(i, u), u = r._pack_next, o = 3; s > o; o++) {
                Xu(r, u, i = e[o]);
                var p = 0, v = 1, d = 1;
                for (a = u._pack_next; a !== u; a = a._pack_next, v++)if (Ou(a, i)) {
                    p = 1;
                    break
                }
                if (1 == p)for (c = r._pack_prev; c !== a._pack_prev && !Ou(c, i); c = c._pack_prev, d++);
                p ? (d > v || v == d && u.r < r.r ? Fu(r, u = a) : Fu(r = c, u), o--) : (Hu(r, i), u = i, t(i))
            }
    ...
    function Vu(n, t, e, r) {
        var u = n.children;
        if (n.x = t += r * n.x, n.y = e += r * n.y, n.r *= r, u)for (var i = -1, o = u.length; ++i < o;)Vu(u[i], t, e, r)
    }
    ...
    function Wu(n) {
        var t = n.children;
        return t && t.length ? Wu(t[0]) : n
    }

    function Ju(n) {
        var t, e = n.children;
        return e && (t = e.length) ? Ju(e[t - 1]) : n
    }
    ...
    function ni(n) {
        return n.rangeExtent ? n.rangeExtent() : Qu(n.range())
    }
    ...
    function ii(n, t, e, r) {
        function u() {
            var u = Math.min(n.length, t.length) > 2 ? ui : ti, c = r ? eu : tu;
            return o = u(n, t, c, e), a = u(t, n, c, Tr), i
        }
        ...
        return i.invert = function (n) {
            ...
            return i.range(n).interpolate(Wr)
        }, i.clamp = function (n) {
    ...
    function ai(n, t) {
        return ei(n, ri(ci(n, t)[2]))
    }

    function ci(n, t) {
        null == t && (t = 10);
        var e = Qu(n), r = e[1] - e[0], u = Math.pow(10, Math.floor(Math.log(r / t) / Math.LN10)), i = t / r * u;
    ...
    function li(n, t, e) {
        var r = -Math.floor(Math.log(ci(n, t)[2]) / Math.LN10 + .01);
        return Zo.format(e ? e.replace(tc, function (n, t, e, u, i, o, a, c, s, l) {
            return[t, e, u, i, o, a, c, s || "." + (r - 2 * ("%" === l)), l].join("")
        }) : ",." + r + "f")
    }
    ...
    function fi(n, t, e, r) {
        ...
        return o.invert = function (t) {
            ...
            var t = ei(r.map(u), e ? Math : cs);
            return n.domain(t), r = t.map(i), o
        }, o.ticks = function () {
            var n = Qu(r), o = [], a = n[0], c = n[1], s = Math.floor(u(a)), l = Math.ceil(u(c)), f = t % 1 ? 2 : t;
            if (isFinite(l - s)) {
                if (e) {
    ...
    function vi(n, t) {
        function e() {
            var e = 0, i = t.length;
            for (u = []; ++e < i;)u[e - 1] = Zo.quantile(n, e / i);
            return r
        }
    ...
    function wi(n) {
        ...
        var e = Ie, r = Ze, u = Zt, i = Si, o = i.key, a = .7;
        return t.x = function (n) {
            ...
            return arguments.length ? (o = "function" == typeof n ? i = n : (i = vs.get(n) || Si).key, t) : o
    ...
    function Li(n, t) {
        return n.length < 3 ? Si(n) : n[0] + qi((n.push(n[0]), n), zi([n[n.length - 2]].concat(n, [n[1]]), t))
    }
    ...
    function qi(n, t) {
        if (t.length < 1 || n.length != t.length && n.length != t.length + 2)return Si(n);
    ...
    function Ri(n) {
        if (n.length < 3)return Si(n);
        var t = 1, e = n.length, r = n[0], u = r[0], i = r[1], o = [u, u, u, (r = n[1])[0]], a = [i, i, i, r[1]], c = [u, ",", i, "L", ji(ys, o), ",", ji(ys, a)];
        for (n.push(n[e - 1]); ++t <= e;)r = n[t], o.shift(), o.push(r[0]), a.shift(), a.push(r[1]), Hi(c, o, a);
        return n.pop(), c.push("L", r), c.join("")
    }

    function Di(n) {
        if (n.length < 4)return Si(n);
        for (var t, e = [], r = -1, u = n.length, i = [0], o = [0]; ++r < 3;)t = n[r], i.push(t[0]), o.push(t[1]);
        for (e.push(ji(ys, i) + "," + ji(ys, o)), --r; ++r < u;)t = n[r], i.shift(), i.push(t[0]), o.shift(), o.push(t[1]), Hi(e, i, o);
        return e.join("")
    }

    function Pi(n) {
        for (var t, e, r = -1, u = n.length, i = u + 4, o = [], a = []; ++r < 4;)e = n[r % u], o.push(e[0]), a.push(e[1]);
        for (t = [ji(ys, o), ",", ji(ys, a)], --r; ++r < i;)e = n[r % u], o.shift(), o.push(e[0]), a.shift(), a.push(e[1]), Hi(t, o, a);
        return t.join("")
    }
    ...
    function Hi(n, t, e) {
        n.push("C", ji(ds, t), ",", ji(ds, e), ",", ji(ms, t), ",", ji(ms, e), ",", ji(ys, t), ",", ji(ys, e))
    }
    ...
    function Oi(n) {
        for (var t = 0, e = n.length - 1, r = [], u = n[0], i = n[1], o = r[0] = Fi(u, i); ++t < e;)r[t] = (o + (o = Fi(u = i, i = n[t + 1]))) / 2;
        return r[t] = o, r
    }

    function Yi(n) {
        for (var t, e, r, u, i = [], o = Oi(n), a = -1, c = n.length - 1; ++a < c;)t = Fi(n[a], n[a + 1]), ua(t) < ka ? o[a] = o[a + 1] = 0 : (e = o[a] / t, r = o[a + 1] / t, u = e * e + r * r, u > 9 && (u = 3 * t / Math.sqrt(u), o[a] = u * e, o[a + 1] = u * r));
        for (a = -1; ++a <= c;)u = (n[Math.min(c, a + 1)][0] - n[Math.max(0, a - 1)][0]) / (6 * (1 + o[a] * o[a])), i.push([u || 0, o[a] * u || 0]);
        return i
    }

    function Ii(n) {
        return n.length < 3 ? Si(n) : n[0] + qi(n, Yi(n))
    }

    function Zi(n) {
        for (var t, e, r, u = -1, i = n.length; ++u < i;)t = n[u], e = t[0], r = t[1] + gs, t[0] = e * Math.cos(r), t[1] = e * Math.sin(r);
        return n
    }
    ...
    function Vi(n) {
        ...
        var e = Ie, r = Ie, u = 0, i = Ze, o = Zt, a = Si, c = a.key, s = a, l = "L", f = .7;
        return t.x = function (n) {
            ...
            return arguments.length ? (c = "function" == typeof n ? a = n : (a = vs.get(n) || Si).key, s = a.reverse || a, l = a.closed ? "M" : "L", t) : c
        }, t.tension = function (n) {
    ...
    function Bi(n) {
        return function () {
            var t = n.apply(this, arguments), e = t[0], r = t[1] + gs;
    ...
    function to(n, t, e, r) {
        ...
        if (!o) {
            var a = r.time;
            o = i[e] = {tween: new u, time: a, ease: r.ease, delay: r.delay, duration: r.duration}, ++i.count, Zo.timer(function (r) {
                function u(r) {
    ...
    function ao(n) {
        function t(t) {
            for (var r, u, i, o = [], a = -1, c = 0; ++a < e;)37 === n.charCodeAt(a) && (o.push(n.substring(c, a)), null != (u = Js[r = n.charAt(++a)]) && (r = n.charAt(++a)), (i = Gs[r]) && (r = i(t, null == u ? "e" === r ? " " : "0" : u)), o.push(r), c = a + 1);
            return o.push(n.substring(c, a)), o.join("")
        }

        var e = n.length;
        return t.parse = function (t) {
            var e = {y: 1900, m: 0, d: 1, H: 0, M: 0, S: 0, L: 0, Z: null}, r = co(e, n, t, 0);
    ...
    function co(n, t, e, r) {
        for (var u, i, o, a = 0, c = t.length, s = e.length; c > a;) {
            ...
            if (u = t.charCodeAt(a++), 37 === u) {
                if (o = t.charAt(a++), i = Ks[o in Js ? t.charAt(a++) : o], !i || (r = i(n, e, r)) < 0)return-1
    ...
    function Ho(n, t, e) {
        ...
        function u(n, e) {
            ...
            return i == el.length ? [t.year, ci(n.map(function (n) {
                return n / 31536e6
            }), e)[2]] : i ? t[u / el[i - 1] < el[i] / u ? i - 1 : i] : [ol, ci(n, e)[2]]
        }
        ...
        return r.invert = function (t) {
            ...
            var i = r.domain(), o = Qu(i), a = null == n ? u(o, 10) : "number" == typeof n && u(o, n);
            return a && (n = a[0], t = a[1]), r.domain(ei(i, t > 1 ? {floor: function (t) {
                for (; e(t = n.floor(t));)t = Fo(t - 1);
                return t
            }, ceil: function (t) {
                for (; e(t = n.ceil(t));)t = Fo(+t + 1);
                return t
            }} : n))
        }, r.ticks = function (n, t) {
            var e = Qu(r.domain()), i = null == n ? u(e, 10) : "number" == typeof n ? u(e, n) : !n.range && [
                {range: n},
                t
            ];
    ...
    Zo.ascending = function (n, t) {
        ...
        return arguments.length > 1 && (t = t.map(e)), t = t.filter(n), t.length ? Zo.quantile(t.sort(Zo.ascending), .5) : void 0
    ...
    Zo.bisectLeft = ra.left, Zo.bisect = Zo.bisectRight = ra.right, Zo.shuffle = function (n) {
        ...
        for (var n = -1, e = Zo.min(arguments, t), r = new Array(e); ++n < e;)for (var u, i = -1, o = r[n] = new Array(u); ++i < u;)o[i] = arguments[i][n];
        return r
    ...
    Zo.selection.enter = N, Zo.selection.enter.prototype = da, da.append = pa.append, da.empty = pa.empty, da.node = pa.node, da.call = pa.call, da.size = pa.size, da.select = function (n) {
        ...
        for (var n, t, e = Ms || ++ks, r = [], u = _s || {time: Date.now(), ease: jr, delay: 0, duration: 250}, i = -1, o = this.length; ++i < o;) {
            r.push(n = []);
            for (var a = this[i], c = -1, s = a.length; ++c < s;)(t = a[c]) && to(t, c, e, u), n.push(t)
        }
        return Ki(r, e)
    ...
    var ba = Math.PI, wa = 2 * ba, Sa = ba / 2, ka = 1e-6, Ea = ka * ka, Aa = ba / 180, Ca = 180 / ba, Na = Math.SQRT2, La = 2, Ta = 4;
    Zo.interpolateZoom = function (n, t) {
        function e(n) {
            var t = n * y;
            if (m) {
                var e = O(v), o = i / (La * h) * (e * Y(Na * t + v) - F(v));
                return[r + o * s, u + o * l, i * e / O(Na * t + v)]
            }
        ...
        function l() {
            ...
            function e() {
                for (var t = Zo.event.changedTouches, e = 0, i = t.length; i > e; ++e)d[t[e].identifier] = null;
                var o = n(), c = Date.now();
                if (1 === o.length) {
                    if (500 > c - x) {
            ...
            function i() {
                for (var n, t, e, i, o = Zo.touches(p), c = 0, s = o.length; s > c; ++c, i = null)if (e = o[c], i = d[e.identifier]) {
                    if (t)break;
                    n = e, t = i
                }
                if (i) {
            ...
            function h() {
                if (Zo.event.touches.length) {
                    for (var t = Zo.event.changedTouches, e = 0, r = t.length; r > e; ++e)delete d[t[e].identifier];
        ...
        function h() {
            ...
            d || (d = t(e)), r(Math.pow(2, .002 * qa()) * S.k), u(e, d), a(n)
        }
        ...
        var d, m, y, x, M, _, b, w, S = {x: 0, y: 0, k: 1}, k = [960, 500], E = za, A = "mousedown.zoom", C = "mousemove.zoom", N = "mouseup.zoom", L = "touchstart.zoom", q = g(n, "zoomstart", "zoom", "zoomend");
        return n.event = function (n) {
            ...
            return arguments.length ? (E = null == t ? za : [+t[0], +t[1]], n) : E
        }, n.center = function (t) {
    ...
    var qa, za = [0, 1 / 0], Ra = "onwheel"in $o ? (qa = function () {
    ...
    var Ua = 18, ja = .95047, Ha = 1, Fa = 1.08883, Oa = K.prototype = new Z;
    ...
    var Ja = ".", Ga = ",", Ka = [3, 3], Qa = "$", nc = ["y", "z", "a", "f", "p", "n", "\xb5", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"].map(bt);
    ...
    var tc = /(?:([^{])?([<>=^]))?([+\- ])?([$#])?(0)?(\d+)?(,)?(\.-?\d+)?([a-z%])?/i, ec = Zo.map({b: function (n) {
        return n.toString(2)
    }, c: function (n) {
    ...
    if (Ka) {
        var uc = Ka.length;
        rc = function (n) {
            for (var t = n.length, e = [], r = 0, u = Ka[0]; t > 0 && u > 0;)e.push(n.substring(t -= u, t + u)), u = Ka[r = (r + 1) % uc];
            return e.reverse().join(Ga)
        }
    }
    Zo.geo = {}, kt.prototype = {s: 0, t: 0, add: function (n) {
    ...
    var cc, sc = new kt, lc = {sphere: function () {
        cc += 4 * ba
    ...
    Zo.geo.bounds = function () {
        ...
        return Ea > u && (t = dc, e = mc, r = yc, ka > hc && (t = gc, e = pc, r = vc), u = t * t + e * e + r * r, Ea > u) ? [0 / 0, 0 / 0] : [Math.atan2(e, t) * Ca, H(r / Math.sqrt(u)) * Ca]
    };
    var fc, hc, gc, pc, vc, dc, mc, yc, xc, Mc, _c, bc = {sphere: c, point: Ht, lineStart: Ot, lineEnd: Yt, polygonStart: function () {
        bc.lineStart = It
    }, polygonEnd: function () {
        bc.lineStart = Ot
    }}, wc = Bt(Zt, Qt, te, [-ba, -ba / 2]), Sc = 1e9;
    ...
    var kc, Ec, Ac, Cc, Nc, Lc, Tc = {point: c, lineStart: c, lineEnd: c, polygonStart: function () {
        Ec = 0, Tc.lineStart = ce
    }, polygonEnd: function () {
        Tc.lineStart = Tc.lineEnd = Tc.point = c, kc += ua(Ec / 2)
    }}, qc = {point: se, lineStart: c, lineEnd: c, polygonStart: c, polygonEnd: c}, zc = {point: he, lineStart: ge, lineEnd: pe, polygonStart: function () {
        zc.lineStart = ve
    }, polygonEnd: function () {
    ...
    Zo.geo.transform = function (n) {
        ...
        return n.area = function (n) {
            ...
            return gc = pc = vc = dc = mc = yc = xc = Mc = _c = 0, Zo.geo.stream(n, u(zc)), _c ? [xc / _c, Mc / _c] : yc ? [dc / yc, mc / yc] : vc ? [gc / vc, pc / vc] : [0 / 0, 0 / 0]
        }, n.bounds = function (n) {
    ...
    var Rc, Dc = {sphere: c, point: c, lineStart: Pe, lineEnd: c, polygonStart: c, polygonEnd: c}, Pc = Ue(function (n) {
    ...
    (Zo.geo.stereographic = function () {
        ...
        return Oe(Ye)
    }).raw = Ye, Zo.geom = {}, Zo.geom.hull = function (n) {
        function t(n) {
            if (n.length < 3)return[];
            var t, u, i, o, a, c, s, l, f, h, g, p, v = pt(e), d = pt(r), m = n.length, y = m - 1, x = [], M = [], _ = 0;
            if (v === Ie && r === Ze)t = n; else for (i = 0, t = []; m > i; ++i)t.push([+v.call(this, u = n[i], i), +d.call(this, u, i)]);
            ...
            for (p = M.length; y > o; ++o)if (!(x[o].index < 0)) {
                for (; !Ve(M[p - 2], M[p - 1], x[o].index, t);)--p;
                M[p++] = x[o].index
            }
            var b = [];
    ...
    Oc.area = function () {
        ...
        for (var t, e, r, u, i, o, a = Be(n), c = -1, s = this.length - Be(this), l = this[s - 1]; ++c < s;) {
            for (t = n.slice(), n.length = 0, u = this[c], i = t[(r = t.length - a) - 1], e = -1; ++e < r;)o = t[e], Xe(o, l, u) ? (Xe(i, l, u) || n.push($e(i, o, l, u)), n.push(o)) : Xe(i, l, u) && n.push($e(i, o, l, u)), i = o;
            a && n.push(n[0]), l = u
        }
        return n
    };
    var Yc, Ic, Zc, Vc, Xc, $c = [], Bc = [];
    er.prototype.prepare = function () {
        for (var n, t = this.edges, e = t.length; e--;)n = t[e].edge, n.b && n.a || t.splice(e, 1);
        return t.sort(ur), t.length
    }, pr.prototype = {start: function () {
        return this.edge.l === this.site ? this.edge.a : this.edge.b
    }, end: function () {
        return this.edge.l === this.site ? this.edge.b : this.edge.a
    }}, vr.prototype = {insert: function (n, t) {
        var e, r, u;
        if (n) {
            ...
            e = n
        } else this._ ? (n = xr(this._), t.P = null, t.N = n, n.P = n.L = t, e = n) : (t.P = t.N = null, this._ = t, e = null);
        for (t.L = t.R = null, t.U = e, t.C = !0, n = t; e && e.C;)r = e.U, e === r.L ? (u = r.R, u && u.C ? (e.C = u.C = !1, r.C = !0, n = r) : (n === e.R && (mr(this, e), n = e, e = n.U), e.C = !1, r.C = !0, yr(this, r))) : (u = r.L, u && u.C ? (e.C = u.C = !1, r.C = !0, n = r) : (n === e.L && (yr(this, e), n = e, e = n.U), e.C = !1, r.C = !0, mr(this, r))), e = n.U;
        this._.C = !1
    }, remove: function (n) {
        n.N && (n.N.P = n.P), n.P && (n.P.N = n.N), n.N = n.P = null;
        var t, e, r, u = n.U, i = n.L, o = n.R;
        if (e = i ? o ? xr(o) : i : o, u ? u.L === n ? u.L = e : u.R = e : this._ = e, i && o ? (r = e.C, e.C = n.C, e.L = i, i.U = e, e !== o ? (u = e.U, e.U = n.U, n = e.R, u.L = n, e.R = o, o.U = e) : (e.U = u, u = e, n = e.R)) : (r = n.C, n = e), n && (n.U = u), !r) {
            if (n && n.C)return n.C = !1, void 0;
            do {
                if (n === this._)break;
                if (n === u.L) {
                    if (t = u.R, t.C && (t.C = !1, u.C = !0, mr(this, u), t = u.R), t.L && t.L.C || t.R && t.R.C) {
                        t.R && t.R.C || (t.L.C = !1, t.C = !0, yr(this, t), t = u.R), t.C = u.C, u.C = t.R.C = !1, mr(this, u), n = this._;
                        break
                    }
                } else if (t = u.L, t.C && (t.C = !1, u.C = !0, yr(this, u), t = u.L), t.L && t.L.C || t.R && t.R.C) {
                    t.L && t.L.C || (t.R.C = !1, t.C = !0, mr(this, t), t = u.L), t.C = u.C, u.C = t.L.C = !1, yr(this, u), n = this._;
                    break
                }
                t.C = !0, n = u, u = u.U
            } while (!n.C);
        ...
        function t(n) {
            ...
            return Mr(e(n), a).cells.forEach(function (e, a) {
        ...
        var r = Ie, u = Ze, i = r, o = u, a = Wc;
        return n ? t(n) : (t.links = function (n) {
            return Mr(e(n)).edges.filter(function (n) {
                return n.l && n.r
            }).map(function (t) {
            ...
            var t = [];
            return Mr(e(n)).cells.forEach(function (e, r) {
                for (var u, i, o = e.site, a = e.edges.sort(ur), c = -1, s = a.length, l = a[s - 1].edge, f = l.l === o ? l.r : l.l; ++c < s;)u = l, i = f, l = a[c].edge, f = l.l === o ? l.r : l.l, r < i.i && r < f.i && br(o, i, f) < 0 && t.push([n[r], n[i.i], n[f.i]])
            }), t
        }, t.x = function (n) {
            ...
            return arguments.length ? (a = null == n ? Wc : n, t) : a === Wc ? null : a
        }, t.size = function (n) {
    ...
    Zo.geom.delaunay = function (n) {
        ...
        function i(n) {
            ...
            function s(n, t, e, r, u, o, a, c) {
                ...
                n.leaf = !1, n = n.nodes[g] || (n.nodes[g] = kr()), f ? u = s : a = s, h ? o = l : c = l, i(n, t, e, r, u, o, a, c)
            }
        ...
        var o, a = Ie, c = Ze;
        return(o = arguments.length) ? (a = wr, c = Sr, 3 === o && (u = e, r = t, e = t = 0), i(n)) : (i.x = function (n) {
    ...
    }, Zo.interpolateRgb = Ar, Zo.interpolateObject = Cr, Zo.interpolateNumber = Nr, Zo.interpolateString = Lr;
    var Jc = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g;
    Zo.interpolate = Tr, Zo.interpolators = [function (n, t) {
        var e = typeof t;
        return("string" === e ? Ia.has(t) || /^(#|rgb\(|hsl\()/.test(t) ? Ar : Lr : t instanceof Z ? Ar : "object" === e ? Array.isArray(t) ? qr : Cr : Nr)(n, t)
    }], Zo.interpolateArray = qr;
    var Gc = function () {
        return vt
    }, Kc = Zo.map({linear: Gc, poly: Hr, quad: function () {
        return Pr
    }, cubic: function () {
        return Ur
    }, sin: function () {
        ...
        return Yr
    }, elastic: Ir, back: Zr, bounce: function () {
        return Vr
    }}), Qc = Zo.map({"in": vt, out: Rr, "in-out": Dr, "out-in": function (n) {
        return Dr(Rr(n))
    }});
    Zo.ease = function (n) {
        var t = n.indexOf("-"), e = t >= 0 ? n.substring(0, t) : n, r = t >= 0 ? n.substring(t + 1) : "in";
        return e = Kc.get(e) || Gc, r = Qc.get(r) || vt, zr(r(e.apply(null, Vo.call(arguments, 1))))
    }, Zo.interpolateHcl = Xr, Zo.interpolateHsl = $r, Zo.interpolateLab = Br, Zo.interpolateRound = Wr, Zo.transform = function (n) {
        ...
        return(Zo.transform = function (n) {
            ...
            return new Jr(e ? e.matrix : ns)
        })(n)
    }, Jr.prototype.toString = function () {
        return"translate(" + this.translate + ")rotate(" + this.rotate + ")skewX(" + this.skew + ")scale(" + this.scale + ")"
    };
    var ns = {a: 1, b: 0, c: 0, d: 1, e: 0, f: 0};
    Zo.interpolateTransform = nu, Zo.layout = {}, Zo.layout.bundle = function () {
        return function (n) {
            for (var t = [], e = -1, r = n.length; ++e < r;)t.push(ru(n[e]));
            return t
        }
        ...
        var e, r, u, i, o, a = {}, c = Zo.dispatch("start", "tick", "end"), s = [1, 1], l = .9, f = ts, h = es, g = -30, p = .1, v = .8, d = [], m = [];
        return a.tick = function () {
            ...
            if (g)for (lu(t = Zo.geom.quadtree(d), r, o), e = -1; ++e < _;)(a = d[e]).fixed || t.visit(n(a));
            ...
            return e || (e = Zo.behavior.drag().origin(vt).on("dragstart.force", ou).on("drag.force", t).on("dragend.force", au)), arguments.length ? (this.on("mouseover.force", cu).on("mouseout.force", su).call(e), void 0) : e
        }, Zo.rebind(a, c, "on")
    };
    var ts = 20, es = 1;
    Zo.layout.hierarchy = function () {
        ...
        function n(i) {
            ...
            null != e && s.sort(e === rs ? function (n, t) {
                return o[t] - o[n]
            } : function (n, t) {
                return e(i[n], i[t])
            });
    ...
    Zo.layout.stack = function () {
        ...
        var t = vt, e = xu, r = Mu, u = yu, i = du, o = mu;
        return n.values = function (e) {
            return arguments.length ? (t = e, n) : t
        }, n.order = function (t) {
            return arguments.length ? (e = "function" == typeof t ? t : us.get(t) || xu, n) : e
        }, n.offset = function (t) {
            return arguments.length ? (r = "function" == typeof t ? t : is.get(t) || Mu, n) : r
        }, n.x = function (t) {
            return arguments.length ? (i = t, n) : i
        }, n.y = function (t) {
    ...
    var us = Zo.map({"inside-out": function (n) {
        var t, e, r = n.length, u = n.map(_u), i = n.map(bu), o = Zo.range(r).sort(function (n, t) {
            return u[n] - u[t]
        }), a = 0, c = 0, s = [], l = [];
    ...
    }, "default": xu}), is = Zo.map({silhouette: function (n) {
    ...
    Zo.layout.histogram = function () {
        ...
        function n(n, i) {
            ...
            function c(n, t, r) {
                if (t) {
                    for (var u, i = n, o = n, a = t, c = n.parent.children[0], s = i._tree.mod, l = o._tree.mod, f = a._tree.mod, h = c._tree.mod; a = Nu(a), i = Cu(i), a && i;)c = Cu(c), o = Nu(o), o._tree.ancestor = n, u = a._tree.prelim + f - i._tree.prelim - s + e(a, i), u > 0 && (Pu(Uu(a, n, r), n, u), s += u, l += u), f += a._tree.mod, s += i._tree.mod, h += c._tree.mod, l += o._tree.mod;
                    a && !Nu(o) && (o._tree.thread = a, o._tree.mod += f - l), i && !Cu(c) && (c._tree.thread = i, c._tree.mod += s - h, r = n)
                }
                return r
            }
            ...
            var f = Lu(l, qu), h = Lu(l, Tu), g = Lu(l, zu), p = f.x - e(f, h) / 2, v = h.x + e(h, f) / 2, d = g.depth || 1;
            return Ru(l, u ? function (n) {
        ...
        var t = Zo.layout.hierarchy().sort(null).value(null), e = Au, r = [1, 1], u = !1;
        ...
        function n(n, i) {
            ...
            if (a.x = a.y = 0, Ru(a, function (n) {
                n.r = +l(n.value)
            }), Ru(a, Yu), r) {
                var f = r * (t ? 1 : Math.max(2 * a.r / c, 2 * a.r / s)) / 2;
                Ru(a, function (n) {
                    n.r += f
                }), Ru(a, Yu), Ru(a, function (n) {
                    n.r -= f
                })
            }
            return Vu(a, c / 2, s / 2, t ? 1 : 1 / Math.max(2 * a.r / c, 2 * a.r / s)), o
        }

        var t, e = Zo.layout.hierarchy().sort(ju), r = 0, u = [1, 1];
        ...
        function n(n, i) {
            ...
            Ru(c, function (n) {
                var t = n.children;
                t && t.length ? (n.x = Bu(t), n.y = $u(t)) : (n.x = o ? s += e(n, o) : 0, n.y = 0, o = n)
            });
            var l = Wu(c), f = Ju(c), h = l.x - e(l, f) / 2, g = f.x + e(f, l) / 2;
            return Ru(c, u ? function (n) {
        ...
        var o, a = Zo.layout.hierarchy(), c = Math.round, s = [1, 1], l = null, f = Gu, h = !1, g = "squarify", p = .5 * (1 + Math.sqrt(5));
        return i.size = function (n) {
            return arguments.length ? (s = n, i) : s
        }, i.padding = function (n) {
            function t(t) {
                var e = n.call(i, t, t.depth);
                return null == e ? Gu(t) : Ku(t, "number" == typeof e ? [e, e, e, e] : e)
            }
            ...
            var r;
            return f = null == (l = n) ? Gu : "function" == (r = typeof n) ? t : "number" === r ? (n = [n, n, n, n], e) : e, i
        }, i.round = function (n) {
    ...
    var os = {floor: vt, ceil: vt};
    Zo.scale.linear = function () {
        return ii([0, 1], [0, 1], Tr, !1)
    }, Zo.scale.log = function () {
        return fi(Zo.scale.linear().domain([0, 1]), 10, !0, [1, 10])
    };
    var as = Zo.format(".0e"), cs = {floor: function (n) {
        return-Math.ceil(-n)
    }, ceil: function (n) {
        return-Math.floor(-n)
    }};
    Zo.scale.pow = function () {
        return hi(Zo.scale.linear(), 1, [0, 1])
        ...
        return Zo.scale.ordinal().range(ss)
    }, Zo.scale.category20 = function () {
        return Zo.scale.ordinal().range(ls)
    }, Zo.scale.category20b = function () {
        return Zo.scale.ordinal().range(fs)
    }, Zo.scale.category20c = function () {
        return Zo.scale.ordinal().range(hs)
    };
    var ss = [2062260, 16744206, 2924588, 14034728, 9725885, 9197131, 14907330, 8355711, 12369186, 1556175].map(it), ls = [2062260, 11454440, 16744206, 16759672, 2924588, 10018698, 14034728, 16750742, 9725885, 12955861, 9197131, 12885140, 14907330, 16234194, 8355711, 13092807, 12369186, 14408589, 1556175, 10410725].map(it), fs = [3750777, 5395619, 7040719, 10264286, 6519097, 9216594, 11915115, 13556636, 9202993, 12426809, 15186514, 15190932, 8666169, 11356490, 14049643, 15177372, 8077683, 10834324, 13528509, 14589654].map(it), hs = [3244733, 7057110, 10406625, 13032431, 15095053, 16616764, 16625259, 16634018, 3253076, 7652470, 10607003, 13101504, 7695281, 10394312, 12369372, 14342891, 6513507, 9868950, 12434877, 14277081].map(it);
    Zo.scale.quantile = function () {
        ...
        function n() {
            var n = t.apply(this, arguments), i = e.apply(this, arguments), o = r.apply(this, arguments) + gs, a = u.apply(this, arguments) + gs, c = (o > a && (c = o, o = a, a = c), a - o), s = ba > c ? "0" : "1", l = Math.cos(o), f = Math.sin(o), h = Math.cos(a), g = Math.sin(a);
            return c >= ps ? n ? "M0," + i + "A" + i + "," + i + " 0 1,1 0," + -i + "A" + i + "," + i + " 0 1,1 0," + i + "M0," + n + "A" + n + "," + n + " 0 1,0 0," + -n + "A" + n + "," + n + " 0 1,0 0," + n + "Z" : "M0," + i + "A" + i + "," + i + " 0 1,1 0," + -i + "A" + i + "," + i + " 0 1,1 0," + i + "Z" : n ? "M" + i * l + "," + i * f + "A" + i + "," + i + " 0 " + s + ",1 " + i * h + "," + i * g + "L" + n * h + "," + n * g + "A" + n + "," + n + " 0 " + s + ",0 " + n * l + "," + n * f + "Z" : "M" + i * l + "," + i * f + "A" + i + "," + i + " 0 " + s + ",1 " + i * h + "," + i * g + "L0,0" + "Z"
        }

        var t = xi, e = Mi, r = _i, u = bi;
        return n.innerRadius = function (e) {
            ...
            var n = (t.apply(this, arguments) + e.apply(this, arguments)) / 2, i = (r.apply(this, arguments) + u.apply(this, arguments)) / 2 + gs;
    ...
    var vs = Zo.map({linear: Si, "linear-closed": ki, step: Ei, "step-before": Ai, "step-after": Ci, basis: Ri, "basis-open": Di, "basis-closed": Pi, bundle: Ui, cardinal: Ti, "cardinal-open": Ni, "cardinal-closed": Li, monotone: Ii});
    vs.forEach(function (n, t) {
        t.key = n, t.closed = /-closed$/.test(n)
    });
    var ds = [0, 2 / 3, 1 / 3, 0], ms = [0, 1 / 3, 2 / 3, 0], ys = [0, 1 / 6, 2 / 3, 1 / 6];
    Zo.svg.line.radial = function () {
        var n = wi(Zi);
        return n.radius = n.x, delete n.x, n.angle = n.y, delete n.y, n
    }, Ai.reverse = Ci, Ci.reverse = Ai, Zo.svg.area = function () {
        return Vi(vt)
        ...
        function t(n, t, e, r) {
            var u = t.call(n, e, r), i = a.call(n, u, r), o = c.call(n, u, r) + gs, l = s.call(n, u, r) + gs;
    ...
    var xs = Zo.map({circle: Gi, cross: function (n) {
    ...
    Ss.call = pa.call, Ss.empty = pa.empty, Ss.node = pa.node, Ss.size = pa.size, Zo.transition = function (n) {
        ...
        for (var o = -1, a = this.length; ++o < a;) {
            i.push(t = []);
            for (var c = this[o], s = -1, l = c.length; ++s < l;)(r = c[s]) && (e = n.call(r, r.__data__, s, o)) ? ("__data__"in r && (e.__data__ = r.__data__), to(e, s, u, r.__transition__[u]), t.push(e)) : t.push(null)
        }
        return Ki(i, u)
        ...
        for (var c = -1, s = this.length; ++c < s;)for (var l = this[c], f = -1, h = l.length; ++f < h;)if (r = l[f]) {
            ...
            for (var g = -1, p = e.length; ++g < p;)(u = e[g]) && to(u, g, o, i), t.push(u)
        }
        return Ki(a, o)
        ...
        var o = "transform" == n ? nu : Tr, a = Zo.ns.qualify(n);
        ...
        function u(t) {
            return null == t ? r : (t += "", function () {
                ...
                return u !== t && (r = Tr(u, t), function (t) {
        ...
        for (var n, t, e, r, u = this.id, i = ++ks, o = [], a = 0, c = this.length; c > a; a++) {
            o.push(n = []);
            for (var t = this[a], s = 0, l = t.length; l > s; s++)(e = t[s]) && (r = Object.create(e.__transition__[u]), r.delay += r.duration, to(e, s, i, r)), n.push(e)
        }
        return Ki(o, i)
    }, Zo.svg.axis = function () {
        function n(n) {
            n.each(function () {
                var n, s = Zo.select(this), l = this.__chart__ || e, f = this.__chart__ = e.copy(), h = null == c ? f.ticks ? f.ticks.apply(f, a) : f.domain() : c, g = null == t ? f.tickFormat ? f.tickFormat.apply(f, a) : vt : t, p = s.selectAll(".tick").data(h, f), v = p.enter().insert("g", ".domain").attr("class", "tick").style("opacity", ka), d = Zo.transition(p.exit()).style("opacity", ka).remove(), m = Zo.transition(p).style("opacity", 1), y = ni(f), x = s.selectAll(".domain").data([0]), M = (x.enter().append("path").attr("class", "domain"), Zo.transition(x));
    ...
    var Es = "bottom", As = {top: 1, right: 1, bottom: 1, left: 1};
    Zo.svg.brush = function () {
        function n(i) {
            i.each(function () {
                ...
                c && (l = ni(c), h.attr("x", l[0]).attr("width", l[1] - l[0]), e(f)), s && (l = ni(s), h.attr("y", l[0]).attr("height", l[1] - l[0]), r(f)), t(f)
            })
        }
        ...
        function u() {
            ...
            function d() {
                ...
                M && (n[0] += M[0], n[1] += M[1]), C || (Zo.event.altKey ? (x || (x = [(l[0] + l[1]) / 2, (h[0] + h[1]) / 2]), L[0] = l[+(n[0] < x[0])], L[1] = h[+(n[1] < x[1])]) : x = null), E && m(n, c, 0) && (e(S), u = !0), A && m(n, s, 1) && (r(S), u = !0), u && (t(S), w({type: "brush", mode: C ? "move" : "resize"}))
            }

            function m(n, t, e) {
                var r, u, a = ni(t), c = a[0], s = a[1], f = L[e], g = e ? h : l, d = g[1] - g[0];
            ...
            if (Zo.event.changedTouches ? T.on("touchmove.brush", d).on("touchend.brush", y) : T.on("mousemove.brush", d).on("mouseup.brush", y), S.interrupt().selectAll("*").interrupt(), C)L[0] = l[0] - L[0], L[1] = h[0] - L[1]; else if (k) {
                var q = +/w$/.test(k), z = +/^n/.test(k);
                M = [l[1 - q] - L[0], h[1 - z] - L[1]], L[0] = l[q], L[1] = h[z]
            } else Zo.event.altKey && (x = L.slice());
        ...
        var i, o, a = g(n, "brushstart", "brush", "brushend"), c = null, s = null, l = [0, 0], h = [0, 0], p = !0, v = !0, d = Ns[0];
        return n.event = function (n) {
            n.each(function () {
    ...
    var Cs = {n: "ns-resize", e: "ew-resize", s: "ns-resize", w: "ew-resize", nw: "nwse-resize", ne: "nesw-resize", se: "nwse-resize", sw: "nesw-resize"}, Ns = [
        ["n", "e", "s", "w", "nw", "ne", "se", "sw"],
        ["e", "w"],
        ["n", "s"],
        []
    ], Ls = Zo.time = {}, Ts = Date, qs = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"];
    uo.prototype = {getDate: function () {
    ...
    var zs = Date.prototype, Rs = "%a %b %e %X %Y", Ds = "%m/%d/%Y", Ps = "%H:%M:%S", Us = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"], js = ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"], Hs = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], Fs = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"];
    ...
    var Os = so(Us), Ys = lo(Us), Is = so(js), Zs = lo(js), Vs = so(Hs), Xs = lo(Hs), $s = so(Fs), Bs = lo(Fs), Ws = /^%/, Js = {"-": "", _: " ", 0: "0"}, Gs = {a: function (n) {
        return js[n.getDay()]
    }, A: function (n) {
        return Us[n.getDay()]
    }, b: function (n) {
    ...
    }, x: ao(Ds), X: ao(Ps), y: function (n, t) {
        return fo(n.getFullYear() % 100, t, 2)
    }, Y: function (n, t) {
        return fo(n.getFullYear() % 1e4, t, 4)
    }, Z: Do, "%": function () {
        return"%"
    }}, Ks = {a: ho, A: go, b: yo, B: xo, c: Mo, d: Co, e: Co, H: Lo, I: Lo, j: No, L: zo, m: Ao, M: To, p: Ro, S: qo, U: vo, w: po, W: mo, x: _o, X: bo, y: So, Y: wo, Z: ko, "%": Po}, Qs = /^\s*\d+/, nl = Zo.map({am: 0, pm: 1});
    ao.utc = Uo;
    ...
    ao.iso = Date.prototype.toISOString && +new Date("2000-01-01T00:00:00.000Z") ? jo : tl, jo.parse = function (n) {
        ...
        return new Ts(36e5 * (Math.floor(n / 36e5 - t) + t))
    }, function (n, t) {
    ...
    var el = [1e3, 5e3, 15e3, 3e4, 6e4, 3e5, 9e5, 18e5, 36e5, 108e5, 216e5, 432e5, 864e5, 1728e5, 6048e5, 2592e6, 7776e6, 31536e6], rl = [
        [Ls.second, 1],
        [Ls.second, 5],
        [Ls.second, 15],
        [Ls.second, 30],
